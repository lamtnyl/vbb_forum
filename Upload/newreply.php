...
if ($_POST['do'] == 'postreply')
{
	...
	else
	{
		...
		if ($vbulletin->GPC['ajax'])
		{
			...
			if ($cms_redirect)
			{
				/* This is a CMS comment, and we got here by posting from the article.
				   We dont need most of the stuff below, its just not used. All we need is 
				   to do the mark read & facebook stuff, and then return the valid redirect XML. */
