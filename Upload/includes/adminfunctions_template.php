...
function build_template_id_cache($styleid, $doreturn = false, $parentids = false)
{
	...
	// Grab -1 templates that don't exist in -2, add them to the template list
	// Not every template is modified for the mobile style and this saves having to duplicate templates into the mobile style 
	if ($masterstyleid == -2)
	{
		$temps = $vbulletin->db->query_read("
			SELECT title, templateid, styleid
			FROM " . TABLE_PREFIX . "template
			WHERE 
				styleid = -1
					AND
				title NOT IN ('" . implode("', '", array_keys($templatelist)) . "')
		");
		while($template = $vbulletin->db->fetch_array($temps))
		{
			$templatelist["$template[title]"] = $template['templateid'];
		...
		switch($gettemplate['templatetype'])
		{
			case 'template': // regular template
				...
				if (!$isgrouped)
				{
					...
					$only[$ugcount_key] = construct_phrase(fetch_phrase('ungrouped_templates_x', 'style', '', false, false, -1), $ugcount);
				}
			break;

			case 'stylevar': // stylevar
				$templates[fetch_phrase('stylevar_special_templates', 'style', '', false, false, -1)][] = $gettemplate;
			break;

			case 'css': // css
				$templates[fetch_phrase('css_special_templates', 'style', '', false, false, -1)][] = $gettemplate;
			break;

			case 'replacement': // replacement
				$templates[fetch_phrase('replacement_var_special_templates', 'style', '', false, false, -1)][] = $gettemplate;
			break;
		}
	}
	unset($template);
...
$languageid = ($_REQUEST['do'] == 'download') ? -1 : false;
...
(
	// phrased groups
	'buddylist'      => fetch_phrase('group_buddy_list', 'style', '', false, false, $languageid),
	'calendar'       => fetch_phrase('group_calendar', 'style', '', false, false, $languageid),
	'faq'            => fetch_phrase('group_faq', 'style', '', false, false, $languageid),
	'reputation'     => fetch_phrase('group_user_reputation', 'style', '', false, false, $languageid),
	'poll'           => fetch_phrase('group_poll', 'style', '', false, false, $languageid),
	'pm'             => fetch_phrase('group_private_message', 'style', '', false, false, $languageid),
	'register'       => fetch_phrase('group_registration', 'style', '', false, false, $languageid),
	'search'         => fetch_phrase('group_search', 'style', '', false, false, $languageid),
	'usercp'         => fetch_phrase('group_user_control_panel', 'style', '', false, false, $languageid),
	'usernote'       => fetch_phrase('group_user_note', 'style', '', false, false, $languageid),
	'whosonline'     => fetch_phrase('group_whos_online', 'style', '', false, false, $languageid),
	'showgroup'      => fetch_phrase('group_show_groups', 'style', '', false, false, $languageid),
	'posticon'       => fetch_phrase('group_post_icon', 'style', '', false, false, $languageid),
	'userfield'      => fetch_phrase('group_user_profile_field', 'style', '', false, false, $languageid),
	'bbcode'         => fetch_phrase('group_bb_code_layout', 'style', '', false, false, $languageid),
	'help'           => fetch_phrase('group_help', 'style', '', false, false, $languageid),
	'editor'         => fetch_phrase('group_editor', 'style', '', false, false, $languageid),
	'forumdisplay'   => fetch_phrase('group_forum_display', 'style', '', false, false, $languageid),
	'forumhome'      => fetch_phrase('group_forum_home', 'style', '', false, false, $languageid),
	'pagenav'        => fetch_phrase('group_page_navigation', 'style', '', false, false, $languageid),
	'postbit'        => fetch_phrase('group_postbit', 'style', '', false, false, $languageid),
	'posthistory'    => fetch_phrase('group_posthistory', 'style', '', false, false, $languageid),
	'threadbit'      => fetch_phrase('group_threadbit', 'style', '', false, false, $languageid),
	'im_'            => fetch_phrase('group_instant_messaging', 'style', '', false, false, $languageid),
	'memberinfo'     => fetch_phrase('group_member_info', 'style', '', false, false, $languageid),
	'memberlist'     => fetch_phrase('group_members_list', 'style', '', false, false, $languageid),
	'moderation'     => fetch_phrase('group_moderation', 'style', '', false, false, $languageid),
	'modify'         => fetch_phrase('group_modify_user_option', 'style', '', false, false, $languageid),
	'new'            => fetch_phrase('group_new_posting', 'style', '', false, false, $languageid),
	'showthread'     => fetch_phrase('group_show_thread', 'style', '', false, false, $languageid),
	'smiliepopup'    => fetch_phrase('group_smilie_popup', 'style', '', false, false, $languageid),
	'subscribe'      => fetch_phrase('group_subscribed_thread', 'style', '', false, false, $languageid),
	'whoposted'      => fetch_phrase('group_who_posted', 'style', '', false, false, $languageid),
	'threadadmin'    => fetch_phrase('group_thread_administration', 'style', '', false, false, $languageid),
	'navbar'         => fetch_phrase('group_navigation_breadcrumb', 'style', '', false, false, $languageid),
	'printthread'    => fetch_phrase('group_printable_thread', 'style', '', false, false, $languageid),
	'attachmentlist' => fetch_phrase('group_attachment_list', 'style', '', false, false, $languageid),
	'userinfraction' => fetch_phrase('group_user_infraction', 'style', '', false, false, $languageid),
	'subscription'   => fetch_phrase('group_paid_subscriptions', 'style', '', false, false, $languageid),
	'announcement'   => fetch_phrase('announcement', 'global', '', false, false, $languageid),
	'visitormessage' => fetch_phrase('group_visitor_message', 'style', '', false, false, $languageid),
	'humanverify'    => fetch_phrase('group_human_verification', 'style', '', false, false, $languageid),
	'socialgroups'	 => fetch_phrase('group_socialgroups', 'style', '', false, false, $languageid),
	'picture'        => fetch_phrase('group_picture_comment', 'style', '', false, false, $languageid),
	'ad_'            => fetch_phrase('group_ad_location', 'style', '', false, false, $languageid),
	'album'          => fetch_phrase('group_album', 'style', '', false, false, $languageid),
	'tag'            => fetch_phrase('tag', 'global', '', false, false, $languageid),
	'assetmanager'   => fetch_phrase('group_asset_manager', 'style', '', false, false, $languageid),
	'css'            => fetch_phrase('group_css', 'style', '', false, false, $languageid),
	'block'          => fetch_phrase('group_block', 'style', '', false, false, $languageid),
	'facebook'		 => fetch_phrase('group_facebook', 'global', '', false, false, $languageid),
	'aaa' => 'AAA Old Backup'
);
