...
class vB_BlockManager
{
	...
	*/
	...
	public function saveNewBlock($blocktypeid, $title, $description, $cachettl, $displayorder, $settings)
	{
		$title = trim($title);
		...
		$this->registry->db->query("INSERT INTO " . TABLE_PREFIX . "block (blocktypeid, title, description, cachettl, displayorder, active)
			VALUES (
