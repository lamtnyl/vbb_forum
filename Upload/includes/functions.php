...
/*
Stop execution at any point and print a trace This will simply return 
if not in debug mode. If passed a variable, it will also output the contents
of that variable. If exit is set to false, it will return after printing 
the trace (this allows multiple traces to be displayed).
*/
function vbstop($variable = null, $showtrace = 99, $showvar = true, $exit = true)
{
	global $vbulletin; 
