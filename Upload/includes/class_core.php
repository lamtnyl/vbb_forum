...
define('FILE_VERSION', '4.1.11'); // this should match installsteps.php
define('SIMPLE_VERSION', '4111'); // see vB_Datastore::check_options()
...
*
* @package	vBulletin
* @version	$Revision: 59600 $
* @date		$Date: 2012-02-24 14:10:44 -0800 (Fri, 24 Feb 2012) $
*/
class vB_Database
{
	/**
	...
	function fetch_config()
	{
		...
		if (sizeof($config) == 0)
		{
			if (file_exists(CWD. '/includes/config.php'))
			{
				...
				die('<br /><br /><strong>Configuration</strong>: #tam/config.php exists, but is not in the 3.6+ format. Please convert your config file via the new config.php.new.');
			}
			else
			{
				die('<br /><br /><strong>Configuration</strong>: #tam/config.php does not exist. Please fill out the data in config.php.new and rename it to config.php');
			}
		}
