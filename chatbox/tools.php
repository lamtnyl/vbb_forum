...
<title>chatbox-cuacity.net</title>
</head>
...
<div align="center"><b>
	<a href="?do=home">Trang chủ</a> |<a href="http://cuacity.net">cuacity.net</a> | <a href="?do=showsmilies">Tất cả smilie</a> | <a href="?do=formadd">Thêm smilie</a> | <a href="?do=banmanage">Thành viên cấm chat</a> | <a href="?do=notice">Thông báo</a> | <a href="?do=badword">Từ cấm</a></b>
</div>
<div align="center">
...
if ($_REQUEST['do'] == 'home')
{
	echo "<center>";
	echo "<br /><br />";
	echo "<b>ThptDaiMo.CC - Bot Chatbox Tools ver 1.0 - hacobi1102</b><br />";
	echo "ThptDaiMo.CC</center>";
}
